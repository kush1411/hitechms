...
<div id="content">
    <section class="style-default-bright">
        <div class="section-header">
            <h2 class="text-primary">View Machine Subsubparts</h2>
        </div>
        <div class="section-body">
            <div class="row">
                <div class="col-lg-12 margin-bottom-10">
                    ...
                    if ($userRights['add']) {
                        ?>
                        <a href = "<?php echo base_url() ?>admin/subparts/add" class="btn btn-info btn-xs btn-raised pull-right">Add Subsubparts</a>
                    <?php } ?>
                    <?php
                ...
                <div class="col-lg-12">
                    <div class="table-responsive">
                        <?php if (isset($allsubparts) && !empty($allsubparts)) { ?>
                            <table id="datatable1" class="table table-striped table-hover" width="100%">
                                ...
                                <tbody>
                                    <?php foreach ($allsubparts as $user) { ?>
                                        <tr class="odd gradeX">
                                            <?php if ($userRights['edit'] || $userRights['delete']) { ?> 
                                                <td><?php echo form_checkbox("option[]", $user->MachSubPartID, '', 'class="case"'); ?>
                                                </td>
                                            <?php } ?>
                                            <td class="sorting_1"><?php echo $user->SubPartName; ?></td>
                                            ...
                                            <td>
                                                <?php if ($user->Status == '1') {
                                                    ...
                                                    if ($userRights['edit']) {
                                                        $statusAction = base_url("admin/subparts/deactivate/" . $user->MachSubPartID);
                                                    }
                                                    ?>
                                                    ...
                                                    $statusAction = 'javascript:void(0);';
                                                    if ($userRights['edit']) {
                                                        $statusAction = base_url("admin/subparts/activate/" . $user->MachSubPartID);
                                                    }
                                                    ?>
                                            ...
                                            <td class="center">
                                                <a href="<?php echo base_url() ?>admin/subparts/copy/<?php echo $user->MachSubPartID; ?>" title="Copy" class="btn-edit"><i class="md md-content-copy btn btn-warning btn-xs btn-raised "></i></a>
                                                <?php
                                                    if ($userRights['edit']) {
                                                        ?>
                                                        <a href="<?php echo base_url() ?>admin/subparts/edit/<?php echo $user->MachSubPartID; ?>" title="Edit" class="btn-edit"><i class="md md-edit btn btn-success btn-xs btn-raised "></i></a>
                                                    <?php } if ($userRights['delete']) { ?>
                                                        <a href="<?php echo base_url() ?>admin/subparts/delete/<?php echo $user->MachSubPartID ?>"  title="Delete" class="btn-cross alertme"><i class="md md-delete btn btn-danger btn-xs btn-raised "></i></a>        
                                                            <?php
                                                        }
                                                        ?>
                                            </td>
