    ...
    <section>
        <div class="section-body contain-lg">
            <div class="row">
                <div class="col-lg-12">
                    <?php if ($action == 'edit') { ?> 
                        <h2 class="text-primary">Edit SubPart</h2>
                    <?php } else {
                        ?>
                        <h2 class="text-primary">Create SubPart</h2>
                    <?php } ?>
                </div>
                <div class="col-lg-12">
                    <?php echo $add_error; ?>
                ...
                <div class="col-lg-12">
                    ...
                    if ($action == 'edit') {
                        ...
                        echo form_open_multipart("admin/subparts/edit/$subparts->MachSubPartID", 'id="addadminfrm" class="form"', $hidden);
                    } else {
                        echo form_open_multipart('admin/subparts/add', 'id="addadminfrm" class="form"');
                    }
                    ?>
                    <div class="card">
                        <div class="card-body">
            ...
            v = $("#addadminfrm").validate({
                ...
                rules: {
                    SubPartName: {
                        required: true,
                        remote:{
                            url : "<?= base_url('admin/subparts/check/' . $type->MachSubPartID); ?>",
                            data: {
