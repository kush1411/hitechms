            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    if ($action == 'edit') {
                        ...
                        echo form_open_multipart("operator/machine/edit/$machine->MachID", 'id="addadminfrm" class="form"', $hidden);
                    } else {
                        echo form_open_multipart('operator/machine/add', 'id="addadminfrm" class="form"');
                    }
                    ?>
                    <div class="card">
                        <div class="card-body">
...
<script>
    $(document).on('change', '#refCatID', function () {
        var _id = $(this).val();
        var _url = '<?= base_url() ?>operator/machine/gettype';
        var _type = 'get';
        var _datatype = 'json';
        var _data = {};
        _data['id'] = _id;
    ...
    $(document).on('change', '#refTypeID', function () {
        var _id = $(this).val();
        var _url = '<?= base_url() ?>operator/machine/getmfg';
        var _type = 'get';
        var _datatype = 'json';
        var _data = {};
        _data['id'] = _id;
        ...
        $(document).ready(function () {
            ...
            $("#addadminfrm").validate({
                ...
                rules: {
                    MachCode: {
                        required: true,
                        remote: "<?= base_url('operator/machine/check/' . $machine->MachID); ?>"
                    },
                    ...
                    MachSerialNo: {
                        required: true,
                        remote: "<?= base_url('operator/machine/checkserial/' . $machine->MachID); ?>"
                    },
                    MachWarrantyTo:{
        ...
        $(document).ready(function () {
            ...
            $("#addadminfrm").validate({
                ...
                rules: {
                    MachCode: {
                        required: true,
                        remote: "<?= base_url('operator/machine/check/'); ?>"
                    },
                    refCatID: {required: true},
                    refTypeID: {required: true},
                    refMfgID: {required: true},
                    ...
                    MachSerialNo: {
                        required: true,
                        remote: "<?= base_url('operator/machine/checkserial/'); ?>"
                    },
                    MachWarrantyTo:{
                        greaterThan : '#MachWarrantyFrom'
                    }
