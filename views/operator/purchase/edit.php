...
if ($purchasemst->IsWarranty == 1 || $providerStatus) {
        ...
        <div class="contain-lg">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <?php
                    if ($action == 'edit') {
                        $hidden = array('JobID' => $purchasemst->JobID);
                        echo form_open_multipart("operator/jobmst/edit/$purchasemst->JobID", 'id="addadminfrm" class="form"', $hidden);
                    } else {
