            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    if ($action == 'editparts') {
                        ...
                        echo form_open_multipart("machine/editparts/" . $MachID . "/" . $machineparts->CmpMachPartID, 'id="addadminfrm" class="form"', $hidden);
                    } else {
                        echo form_open_multipart('machine/addparts/' . $MachID, 'id="addadminfrm" class="form"');
                    }
                    ?>
                    <div class="card">
                        <div class="card-body">
...
<script>
    $(document).on('change', '#refMachSubPartID', function () {
        ...
        if (_id == '') {
            ...
            var _url = '<?= base_url() ?>frontend/machine/getSubPart';
            var _type = 'get';
            var _datatype = 'json';
            var _data = {};
            _data['id'] = _id;
            ...
            var _url = '<?= base_url() ?>frontend/machine/getmfgbysubpartid';
            var _type = 'get';
            var _datatype = 'json';
            var _data = {};
            _data['id'] = _id;
        ...
        $(document).ready(function () {
            $("#addadminfrm").validate({
                ...
                rules: {
                    ...
                    SerialNo: {
                        required: true,
                        remote: "<?= base_url('machine/checkserialparts/' . $machineparts->CmpMachPartID); ?>"
                    }
                },
