                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                ...
                                                <?php if ($userRights['edit'] && $user->MachStatus == '1') { ?>
                                                    <a href="<?php echo base_url() ?>machine/info/<?php echo $user->MachID ?>"  title="Machine Info" class="fancybox fancybox.ajax"><i class="md md-assignment btn btn-success btn-xs btn-raised "></i></a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <?php
