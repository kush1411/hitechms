...
class Users extends CI_Model {
    ...
    private $profile_table_name = 'userprofiles'; // user profiles
...
//                $this->create_profile($user_id);
    ...
    function create_user_profile($data) {
        if($this->db->insert('userprofiles', $data)){
			$new = array();
			$new['refCompID'] = $data['user_id'];
			$new['F1SrMode'] = 'manual';
			$new['F1SrType'] = NULL;
			$new['F1SrTypeMode'] = NULL;
			$new['F1SrValue'] = $data['code'];
			$new['F1SrValLength'] = '0';
			$new['F2SrMode'] = 'manual';
			$new['F2SrType'] = NULL;
    ...
    function purge_na($expire_period = 172800) {
        $this->db->where('activated', 0);
        $this->db->where('UNIX_TIMESTAMP(InsDatetime) <', time() - $expire_period);
