...
class My_front extends MY_base {
    ...
    function _get_auto_id() {
        ...
        $refCompID = $this->session->userdata(SITE_NAME . '_user_data')['user_id'];
        ...
        if (!empty($last_insert)) {
            ...
            $newBarcodeStr = '';
            $last_insert_id1 = array();
            $last_insert_id1['F1'] = $last_insert->F1;
            $last_insert_id1['F2'] = $last_insert->F2;
            $last_insert_id1['F3'] = $last_insert->F3;
            $last_insert_id1['F4'] = $last_insert->F4;
            $last_insert_id1['F5'] = $last_insert->F5;
            $last_insert_id1['F6'] = $last_insert->F6;
            $last_insert_id1['F7'] = $last_insert->F7;
            
            $last_insert_id = array_filter($last_insert_id1);
